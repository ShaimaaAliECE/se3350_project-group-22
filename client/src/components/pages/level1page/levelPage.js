...
export default class levelPage extends Component {
    render() {
        return (
            <div>
                ...
                <input type="button" className="random" value="Random Number!" onClick={Random} />
                <form name="rn">
                    {/* <!--step1 --> */}
                    <div className="hide" id="showStep1">
                        <input type="text" id="step1" name="step1" size="40" readOnly />
                        <span style={{display:"inline-block", width: "250px"}}></span>
                        ...
                        <input type="button" value="Next Step" onClick={Next} />
                    </div >

                    {/* //   < !--step 2 -- > */}
                    <div className="hide" id="showStep2">
                        <input type="text" id="step2" name="step2" size="60" readOnly />
                        ...
                        <input type="button" value="Next Step" onClick={nextStep3} />

                    </div >
                    {/* // < !--Step 3: --> */}
                    <div className="hide" id="showStep3">
                        <input type="text" id="step3" name="step3" size="60" readOnly />
                        ...
                        <input type="button" value="Next Step" onClick={nextStep4} />
                    </div >
          ...
          < !--step4 --> */}
                    ...
                    <div className="hide" id="showStep4">
                        <input type="text" id="step4" size="60" readOnly />
            ...
            group 4 -- > */}
                        ...
                        <input type="button" value="Next Step" onClick={nextStep5} />
                    </div >
                    ...
                    <div className="hide" id="showStep5">
                        <input type="text" id="step5" size="60" readOnly />
            ...
            group 4 -- > */}
                        ...
                        <input type="button" value="Next Step" onClick={nextStep6} />
                    </div >
            ...
            group 4 -- > */}
                        ...
                        <input type="button" value="Next Step" onClick={nextStep7} />
                    </div >
                    ...
                    <div className="hide" id="showStep7">
                        <input type="text" id="step7" size="120" readOnly />
   ...
   < span style = "display:inline-block; width: 50px;" ></span >
            ...
            group 4 -- > */}
                        ...
                        <input type="button" value="Next Step" onClick= {nextStep8} />
                    </div >
                    ...
                    <div className="hide" id="showStep8">
                        <input type="text" id="step8" size="120" readOnly />
   ...
   < span style = "display:inline-block; width: 50px;" ></span >
            ...
            <span style={{display:"inline-block", width: "200px"}}></span>
                        ...
                        <input type="button" value="Next Step" onClick= {nextStep9} />
                    </div >
